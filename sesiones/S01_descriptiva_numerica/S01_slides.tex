...
\begin{itemize}
\item Saber Pro 2023 y 2024 --- programa de Negocios Internacionales
...
\begin{exampleblock}{Puntajes de inglés de 5 estudiantes NI}
...
\begin{exampleblock}{Calificación final de Estadística I}
...
\vspace{0.5em}
\alert{La media simple le daría a cada componente el mismo peso}: $(3.8 + 4.2 + 4.5)/3 = 4.17$
\end{frame}
...
\begin{columns}[T]
\column{0.48\textwidth}
\begin{exampleblock}{Sin outlier}
145, 150, 155, 160, 170\\
Rango = $170 - 145 = 25$
\end{exampleblock}

\column{0.48\textwidth}
\begin{exampleblock}{Con outlier}
145, 150, 155, 160, \alert{250}\\
Rango = $250 - 145 = 105$
\end{exampleblock}
\end{columns}
\end{frame}
...
\vspace{0.5em}
\textbf{Propiedades}: siempre $s^2 \geq 0$; unidades en cuadrado de las originales (puntos$^2$).
\end{frame}
...
\begin{exampleblock}{Ejemplo con puntajes de inglés}
...
\vspace{1em}
\begin{exampleblock}{Ejemplo}
Si un estudiante de NI obtiene 250 puntos en inglés (puntaje máximo $\approx$ 200), probablemente es un error de digitación. Pero si obtiene 195, es un valor alto pero plausible.
\end{exampleblock}
\end{frame}
