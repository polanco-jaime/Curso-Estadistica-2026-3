...
\textbf{Contexto}: Queremos estimar la media poblacional de \variable{MOD\_INGLES\_PUNT} para estudiantes de NI en Colombia.
...
\begin{itemize}
  \item Estamos 95\% confiados de que la media poblacional de \variable{MOD\_INGLES\_PUNT} para estudiantes de NI est\'a entre 159.28 y 165.72 puntos.
...
\textbf{Aplicaciones}:
\begin{itemize}
  \item Educaci\'on: ?`qu\'e tan heterog\'eneo es el rendimiento en ingl\'es entre estudiantes de NI?
