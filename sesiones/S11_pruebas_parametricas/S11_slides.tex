...
Los $\hat{\beta}$ siguen insesgados, pero los errores estándar son \textbf{incorrectos}
$\Rightarrow$ los IC y las pruebas $t$ son \textbf{inválidas}.
\end{exampleblock}
\end{frame}
...
\vspace{0.3cm}
\begin{alertblock}{Ejemplo: caso legítimo}
...
\item Los IC y pruebas $t$ se vuelven válidos
