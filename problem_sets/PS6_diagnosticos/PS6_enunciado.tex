...
En este Problem Set explorar\'a diferencias en el puntaje de ingl\'es
seg\'un diferentes variables categ\'oricas, usando ANOVA, pruebas no
param\'etricas y medidas de asociaci\'on.
...
\begin{enumerate}[label=\arabic*)]
  \item \textbf{ANOVA de una v\'ia por estrato socioecon\'omico:} ¿var\'ia el
        ...
        estrato socioecon\'omico de los estudiantes?
  ...
  \item \textbf{Prueba de Mann-Whitney por g\'enero:} ¿difiere el puntaje de
        ingl\'es entre hombres y mujeres en Saber Pro?
        \begin{enumerate}[label=\alph*)]
  ...
  \item \textbf{Prueba $\chi^2$ de independencia: g\'enero $\times$ nivel MCER:}
        ...
        el MCER (A$-$, A1, A2, B1, B2) en Saber Pro?
        \begin{enumerate}[label=\alph*)]
  ...
  \item \textbf{Conclusiones:} sintetice los hallazgos:
        \begin{enumerate}[label=\alph*)]
          ...
          \item ¿Existe brecha de g\'enero en ingl\'es en Saber Pro?
