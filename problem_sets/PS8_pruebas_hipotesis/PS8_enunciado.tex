...
\textbf{Fecha l\'imite de entrega: el d\'ia anterior a la sesi\'on indicada, a m\'as tardar a las 11:59\,p.m.\ (hora Colombia, UTC$-$5).} Entregas tard\'ias pierden el bono. El c\'odigo R debe incluirse. Este PS integra los conceptos de regresi\'on
m\'ultiple y diagn\'osticos avanzados como cierre del curso.

\section*{Datos}

Este PS utiliza los tres datasets del repositorio del curso:
...
\toprule
\textbf{Variable} & \textbf{Dataset} & \textbf{Descripci\'on} & \textbf{Tipo} \\
\midrule
\texttt{MOD\_INGLES\_PUNT}          & Saber Pro & Puntaje ingl\'es (variable dependiente)  & Num\'erico \\
\texttt{PUNT\_INGLES}               & Saber 11  & Puntaje ingl\'es                         & Num\'erico \\
\texttt{PUNT\_MATEMATICAS}          & Saber 11  & Puntaje matem\'aticas                    & Num\'erico \\
\texttt{PUNT\_LECTURA\_CRITICA}     & Saber 11  & Puntaje lectura cr\'itica                & Num\'erico \\
\texttt{PUNT\_SOCIALES\_CIUDADANAS} & Saber 11  & Puntaje sociales y ciudadanas            & Num\'erico \\
\texttt{PUNT\_C\_NATURALES}         & Saber 11  & Puntaje ciencias naturales               & Num\'erico \\
\texttt{estu\_consecutivo\_sb11}    & Cruce     & Llave para vincular con Saber 11         & ID \\
\texttt{estu\_consecutivo\_sbpro}   & Cruce     & Llave para vincular con Saber Pro        & ID \\
\bottomrule
\end{tabular}

\vspace{4pt}
\textit{Use el archivo de cruce para vincular \texttt{ESTU\_CONSECUTIVO}
de Saber 11 con \texttt{ESTU\_CONSECUTIVO} de Saber Pro.}

\section*{Enunciado}

En este Problem Set (capstone) estimar\'a un modelo de regresi\'on lineal
m\'ultiple para predecir el puntaje de ingl\'es en Saber Pro usando
m\'ultiples regresores de Saber 11, y realizar\'a un diagn\'ostico exhaustivo
del modelo.
          ...
          \item Seleccione 4 o m\'as variables de Saber 11 como regresores.
                ...
                \begin{itemize}
                  ...
                  \item \texttt{PUNT\_SOCIALES\_CIUDADANAS} (sociales y
                        ciudadanas)
                  \item \texttt{PUNT\_C\_NATURALES} (ciencias naturales)
                \end{itemize}
  ...
  \item \textbf{Conclusiones y recomendaciones finales:} sintetice el
        ...
        \begin{enumerate}[label=\alph*)]
          \item ¿Cu\'ales son los principales determinantes del puntaje de
                ingl\'es en Saber Pro para estudiantes?
          ...
          \item ¿El modelo tiene utilidad pr\'actica para predecir el
                rendimiento en Saber Pro de futuros estudiantes?
        \end{enumerate}
\end{enumerate}
